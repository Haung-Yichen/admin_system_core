...
columns (email_hash, line_user_id_hash) and changing column types, the safest
...
async def migrate_users():
    ...
    async with engine.begin() as conn:
        ...
        print("   - Add line_user_id_hash column")
...
async def main():
    ...
    response = input("Do you want to proceed with fresh database instructions? (yes/no): ")
    if response.lower() == "yes":
        print()
