...
class UserCreate(UserBase):
    ...
    line_user_id: Annotated[str, Field(min_length=1, max_length=64)]
...
class SOPDocumentBase(BaseSchema):
    ...
    metadata_: Annotated[dict[str, Any] | None, Field(validation_alias="metadata_", serialization_alias="metadata")] = None
